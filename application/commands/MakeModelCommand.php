...
class MakeModelCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('className', InputArgument::REQUIRED, 'File name is required');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $controllerPath = str_replace('commands', 'models', __DIR__);
    ...
    protected function createFile($filePath, $fileName)
    {
        ...
        if ($newFile) {
            ...
            $template = file_get_contents(__DIR__."\\template\\model.stub.php");
